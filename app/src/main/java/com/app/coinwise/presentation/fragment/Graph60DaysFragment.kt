...
class Graph60DaysFragment : Fragment(), OnChartValueSelectedListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_graph60_days, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        swipeToRefresh = view.findViewById(R.id.swipeToRefresh_60days)
        refreshApp()

        lineChartBitcoin = view.findViewById(R.id.line_chart_bitcoin_60days)
        textViewData = view.findViewById(R.id.text_view_dados_60days)
        textViewOpen = view.findViewById(R.id.text_view_open_60days)
        textViewMax = view.findViewById(R.id.text_view_maximo_60days)
        textViewAverage = view.findViewById(R.id.text_view_media_60days)
        textViewClose = view.findViewById(R.id.text_view_close_60days)
        textViewMin = view.findViewById(R.id.text_view_minimo_60days)
        textViewChange = view.findViewById(R.id.text_view_diferenca_60days)
        percentageTextView = view.findViewById(R.id.tv_percentage_60days)
        greenArrowImageView =view.findViewById(R.id.img_up_60days)
        redArrowImageView = view.findViewById(R.id.img_down_60days)
        textViewTodaysPrice = view.findViewById(R.id.tv_todays_price_60days)
    ...
    private fun updateLineChart(bitcoinList: List<Value>, yesterdayPrice: Double) {
        val last60BitcoinList = bitcoinList.takeLast(60)
        val entries = last60BitcoinList.mapIndexed { _, value ->

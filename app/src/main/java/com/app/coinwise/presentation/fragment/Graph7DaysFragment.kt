...
class Graph7DaysFragment : Fragment(), OnChartValueSelectedListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        swipeToRefresh = view.findViewById(R.id.swipeToRefresh_7days)
        refreshApp()
        ...
        percentageTextView = view.findViewById(R.id.tv_percentage_7days)
        greenArrowImageView =view.findViewById(R.id.img_up_7days)
        redArrowImageView =view.findViewById(R.id.img_down_7days)
        textViewTodaysPrice = view.findViewById(R.id.tv_todays_price_7days)
